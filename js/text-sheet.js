...
var text = {
  string1: "Kids, don't drink and drive..... The spaceship is all wrecked and I ran out of power during the emergency landing...:(                           " ,
  string2: "",
...
function narrator(textArray){
  ...
  if (stringCount === 0 && finished === true ){ 
   ...
   else if (stringCount === 7 && finished === true ){ 
    finished = false
    $("#text1").empty();
    displayOnScreen("#text1", textArray[stringCount], 0, textspeed);
    setTimeout(function() {
